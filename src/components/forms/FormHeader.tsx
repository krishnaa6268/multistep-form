          ...
          {stepTitles.map((s) => {
            ...
            return (
              <div
                key={s}
                className={`
                  relative  w-10 md:w-12 lg:w-12 h-10 md:h-12 lg:h-12 flex items-center justify-center rounded-full text-lg font-bold
              ...
              >
                {s}
                {isCompleted && (
                  <span className="absolute top-0 right-0 lg:w-4 w-2 lg:h-4 h-2 bg-green-400 rounded-full shadow-md animate-pulse"></span>
                )}
              </div>
            );
          })}
